...
const shareManager = (source, target, sourceType) => {
  ...
  if (!shareState.sourceShared && shareState.targetShared) {
    // source shareID set to target shareID
